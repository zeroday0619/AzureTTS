...
class MicrosoftTTS:
    ...
    def create_ssml(text: str, lang: str, gender: str, name: str) -> str:
        return f"""<speak version='1.0' xmlns="http://www.w3.org/2001/10/synthesis" xmlns:mstts="https://www.w3.org/2001/mstts" xml:lang='{lang}'><voice xml:lang='{lang}' xml:gender='{gender}' name='{name}'><mstts:express-as style="chat" role='Girl'><prosody rate="30%">{text}</prosody></mstts:express-as></voice></speak>"""
